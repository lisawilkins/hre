...
export const WhyUs = ({ theme, id }) => {
  ...
  const items = [
    ...
    { i: 'bolt', t: 'Commercial-grade standards', d: 'Residential & commercial customers alike receive the same high level of commitment and quality workmanship' },
  ];
  return (
      ...
      <div style={{ display: 'grid', gridTemplateColumns: cols, gap: 16 }}>
        {items.map((it, i) => (
          <div key={i} style={{
            ...
            <h3 style={{ fontFamily: theme.displayFont, fontWeight: theme.displayWeight, fontSize: 20, letterSpacing: '-0.02em', color: theme.ink, margin: 0 }}>{it.t}</h3>
