      ...
      <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1.2fr 1fr', gap: isMobile ? 32 : 48, alignItems: 'center' }}>
        ...
        <div>
          ...
          <h2 style={{
            ...
            fontSize: 'clamp(32px, 4vw, 56px)', lineHeight: 0.95, margin: 0, letterSpacing: '-0.035em',
          }}>
            When it can&apos;t wait, we answer.
          </h2>
          <p style={{ fontFamily: theme.bodyFont, fontSize: 16, lineHeight: 1.55, opacity: 0.92, marginTop: 22 }}>
