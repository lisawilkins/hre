...
const LaneCard = ({ theme, kind, title, lede, icon, go, isMobile }) => (
  <div style={{
  ...
  return (
    <Section theme={theme} id={id}>
      <div style={{
        ...
        <LaneCard theme={theme} kind="Residential" title="For your home" lede="Panel swaps, EV chargers, smart home, and repairs — handled like it's our own house." icon="house" go={() => navigate('/residential')} isMobile={isMobile} />
        <LaneCard theme={theme} kind="Commercial" title="For your business" lede="Twenty-plus years of TIs, ground-up builds, and service upgrades across Western WA." icon="building" go={() => navigate('/commercial')} isMobile={isMobile} />
      </div>
    </Section>
  );
};
